...
using System.IO;
using MJLGameEngine.Object;
using MJLGameEngine.Object.ParticleGenerator;
using Jitter;
...
namespace MJLGameEngine.Scene
{
    public class Scene
    {
        ...
        {
            MJLGameEngine.Object.Object o = new MJLGameEngine.Object.Object(GameEngineData.game.Content, Static, name, pos, ypr, scale, texture, NormalMap, NormalMap_Enabled, UseDDSNormal);
            Objects.Add(o);
        ...
        private void RenderDebug()
        {
            ...
            foreach (MJLGameEngine.Object.Object obj in Objects)
            {
